...
{
  Game_obj_sheet::Load( _button_params );
...
void Game_obj_sheet_button::Parse( xml::parser& _p )
{
  ...
  Parse_pointer( _p, "callback_function", mf_Callback );
...
void Game_obj_sheet_button::Clean()
{
  std::cout << "Game_obj_button.Clean() is Done  &  ";
