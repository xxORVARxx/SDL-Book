...
namespace event
{
		  ...
		  data::Parser* _p )
  {
    ...
    event::Parameter_variable< T1 >* variable_ptr = new event::Parameter_variable< T1 >( true );
    T1 value = _p->Parse_file< T1 >( _file );
    variable_ptr->Set( value );
    return event::Parameater< T1 >( true, variable_ptr );
  }
		      ...
		      data::Parser* _p )
  {
    ...
    auto variable_ptr = dynamic_cast< event::Parameter_variable< T1 >* >( _trigger_ptr->Get_variable_1());
    return event::Parameater< T1 >( false, variable_ptr );
  }
		      ...
		      std::ifstream& _file, data::Parser* _p )
  {
    ...
    auto variable_ptr = dynamic_cast< event::Parameter_variable< T1 >* >( _trigger_ptr->Get_variable_2());
    return event::Parameater< T1 >( false, variable_ptr );
  }
  ...
  Add( event::i_Trigger* _trigger_ptr,
       ...
       data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_operator< T1, T1 >( _trigger_ptr, _file, _p, []( T1 a, T1 b ) ->T1 { return a + b; } ));
  }
  ...
  Is_equal( event::i_Trigger* _trigger_ptr,
	    ...
	    data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_operator< T1, byte_t >( _trigger_ptr, _file, _p, []( T1 a, T1 b ) ->T1 { return ( a == b ); } ));
  }
  ...
  Convert_to_byte( event::i_Trigger* _trigger_ptr,
		   ...
		   data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_convert< T1, byte_t >( _trigger_ptr, _file, _p ));
  }
  ...
  Convert_to_integer( event::i_Trigger* _trigger_ptr,
		      ...
		      data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_convert< T1, integer_t >( _trigger_ptr, _file, _p ));
  }
  ...
  Convert_to_real( event::i_Trigger* _trigger_ptr,
		   ...
		   data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_convert< T1, real_t >( _trigger_ptr, _file, _p ));
  }
  ...
  Convert_to_string( event::i_Trigger* _trigger_ptr,
		     ...
		     data::Parser* _p )
  {
    return event::Parameater< T1 >( true, new Parameter_convert< T1, string_t >( _trigger_ptr, _file, _p ));
  }
}//event
