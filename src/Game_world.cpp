...
void 
the_World::Setup( int _display_width, int _display_height, double _fps, bool print_fps )
{
...
std::chrono::duration< long int, std::nano > 
the_World::Get_delta_time_duration()
{
  return m_delta_time_duration;
}

double 
the_World::Get_delta_time()
{
